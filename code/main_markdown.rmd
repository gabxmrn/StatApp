...
pays <- "Espagne" # France, US, UK, Italie, Espagne
...
data <- richesse_immo_slacalek(data, pays)
...
chi <- chi(data, date_debut, date_fin, freq = 1)["chi"]
print(chi)

plot_chi(data, 20, date_debut, date_fin, 1)
```
...
cat("\nPMC immédiate:", PMC_unres[[1]], "\n")
cat("PMC éventuelle:", PMC_unres[[2]], "\n")

# Chi = 0.6
PMC_res <- PMC(data, 1, date_debut, date_fin, methode_immo, TRUE)
print("Résultats contraints avec chi=0.6")
cat("\nPMC immédiate:", PMC_res[[1]], "\n")
cat("PMC éventuelle:", PMC_res[[2]], "\n")
